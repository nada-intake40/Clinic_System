...
<!-- ########################################################################################################## -->
        ...
        @method('PUT')
            ...
            <div class="form-group row" style="margin:8px 15px;">
                ...
                <div class="col-md-8">
                    <input class="form-control @error('website') is-invalid @enderror" id="website" type="url" name="website" vale="{{old('website',$clinic->website)}}" required>
                    @error('website')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row" style="margin:8px 15px;">
                ...
                <div class="col-md-8">
                    <textarea class="form-control @error('desciption') is-invalid @enderror" id="desciption" name="notes" rows="10" cols="30">{{$clinic->descriptiom}}</textarea>
                    @error('desciption')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
